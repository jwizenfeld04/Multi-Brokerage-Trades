...
class BBAEAPI:
    def __init__(
        ...
        self._debug_print(
            f"BBAEAPI Initialized for {self.user} with timezone {self.timezone}"
        )

    def _get_default_timezone(self):
        # Fetches system's timezone dynamically, defaulting to 'America/New_York'
    ...
    def get_account_assets(self):
        hex_time = current_epoch_time_as_hex()
        url = (
            f"https://api.bbaepro.com/api/v2/account/assetByUser?_v=6.6.0&_s={hex_time}"
        )
